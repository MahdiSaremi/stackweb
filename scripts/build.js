...
build({
    ...
    outputSize(`dist/stackweb.min.js`)
})

function build(options) {
    options.define || (options.define = {})

    // options.define['STACKWEB_VERSION'] = `'${getFromPackageDotJson('alpinejs', 'version')}'`
